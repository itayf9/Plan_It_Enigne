...
public class LamivhanApplication implements CommandLineRunner {
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT)
            throws IOException {
        // Load client secrets.
        InputStream in = LamivhanApplication.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
        if (in == null) {
    ...
    @Override
    public void run(String... args) throws Exception, IOException, GeneralSecurityException  {
